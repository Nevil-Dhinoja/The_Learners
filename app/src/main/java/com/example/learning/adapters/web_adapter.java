...
public class web_adapter extends RecyclerView.Adapter<web_adapter.MYViewHolder> {
    ...
    public web_adapter(int[] upcomming_img_arry, String[] upcomming_course_cat_arry,
                           String[] upcomming_course_arry) {
    ...
    @Override
    public void onBindViewHolder(@NonNull web_adapter.MYViewHolder holder, int position) {
